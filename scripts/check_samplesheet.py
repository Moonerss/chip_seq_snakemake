...
def check_samplesheet(file_in, file_out):
    ...
    sample,fastq_1,fastq_2,antibody,control,peak_type
    SPT5_T0_REP1,SRR1822153_1.fastq.gz,SRR1822153_2.fastq.gz,SPT5,SPT5_INPUT_REP1,narrow
    SPT5_T0_REP2,SRR1822154_1.fastq.gz,SRR1822154_2.fastq.gz,SPT5,SPT5_INPUT_REP2,narrow
    ...
    with open(file_in, "r", encoding="utf-8-sig") as fin:
        ...
        ## Check header
        MIN_COLS = 2
        HEADER = ["sample", "fastq_1", "fastq_2", "antibody", "control", "peak_type"]
        ...
        for line in fin:
            ...
            sample, fastq_1, fastq_2, antibody, control, peak_type = lspl[: len(HEADER)]
            if sample.find(" ") != -1:
            ...
            ## Check peak type of CHIP-seq
            if peak_type:
                if peak_type not in ['narrow', 'broad']:
                    print_error(
                        "peak_type must be `narrow` or `broad`!",
                        "Line",
                        line,
                    )

            ## Auto-detect paired-end/single-end
            sample_info = []  ## [paired_end, fastq_1, fastq_2, antibody, control, peak_type]
            if sample and fastq_1 and fastq_2:  ## Paired-end short reads
                sample_info = ["TRUE", fastq_1, fastq_2, antibody, control, peak_type]
            elif sample and fastq_1 and not fastq_2:  ## Single-end short reads
                sample_info = ["FALSE", fastq_1, fastq_2, antibody, control, peak_type]
            else:
                print_error("Invalid combination of columns provided!", "Line", line)

            ## Create sample mapping dictionary = {sample: [[ paired_end, fastq_1, fastq_2, antibody, control ]]}
